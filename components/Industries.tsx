    ...
    <section className="py-20 md:py-24 px-4 lg:px-6 max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-8">
        <div>
          ...
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-semibold mb-6 leading-[1.05] tracking-tight">One platform for every <br className="hidden md:block" /> kind of experience.</h2>
